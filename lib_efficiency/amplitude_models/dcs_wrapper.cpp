...
/*
 * Return the DCS amplitudes of a series of events
 *
 * Returns an array of [real imag real imag real imag ...]
 *
 */
extern "C" double* dcs_wrapper_array(double const* const kPx,
    ...
    for (int i=0; i<nEvts; ++i){
        ...
        AmpGenWrapper::Complex_t tmp = dcs_wrapper(evt, kCharge);
